        ...
        <div class="rejilla-admin">
            ...
            <section class="caja-herramienta borde-azul">
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="fila-input">
                        <label>Elige a qué alumnos enviar el material:</label>
                ...
                <form action="guardar_test.php" method="POST" class="formulario-admin">
                    ...
                    <div class="fila-ajustes-examen">
                        <div class="fila-input">
                            ...
                            <input type="text" name="titulo_test" placeholder="Ej: Examen Unidad 1: Gramática" class="input-diseño">
                        </div>
                        <div class="fila-input">
                            <label>Tiempo (minutos)</label>
                            <input type="number" name="tiempo_limite" value="30" class="input-diseño">
                        </div>
                        <div class="fila-input">
                            <label>Fecha Límite</label>
                            <input type="date" name="fecha_limite" class="input-diseño">
                        </div>
                    </div>

                    <div class="fila-input">
                        <label>Asignar a los alumnos:</label>
                        <div class="selector-multi-alumnos">
                            <label class="opcion-alumno"><input type="checkbox" name="alumnos_test[]" value="1"> Carlos Sánchez</label>
                            <label class="opcion-alumno"><input type="checkbox" name="alumnos_test[]" value="2"> David Sola</label>
                            <label class="opcion-alumno"><input type="checkbox" name="alumnos_test[]" value="3"> Ana Belén</label>
                        </div>
                    </div>

                    <div class="bloque-pregunta-creador">
                        <div class="fila-input">
                            <label>Enunciado de la Pregunta</label>
                            <input type="text" name="pregunta_1" placeholder="Escribe aquí la pregunta..." class="input-diseño">
                        </div>
                        <div class="grupo-opciones">
                            <input type="text" name="p1_opcion_a" placeholder="Opción A (Correcta)" class="input-diseño border-verde">
                            <input type="text" name="p1_opcion_b" placeholder="Opción B" class="input-diseño">
                            <input type="text" name="p1_opcion_c" placeholder="Opción C" class="input-diseño">
                        </div>
                    </div>

                    <div class="botones-examen">
                        <button type="button" class="boton-secundario"> + Añadir otra pregunta</button>
                        <button type="submit" class="boton-accion-naranja">PUBLICAR EXAMEN</button>
                    </div>
                </form>
            </section>
